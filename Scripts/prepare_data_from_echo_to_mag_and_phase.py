...
def prepare_data(data_path, basename_image):
    ...
    name_images = [basename_image + '_e1', basename_image + '_e2', basename_image + '_e3']
    suffix_image = '.nii'
...
""" path="/Users/noeedc/Documents/Stage2021/QSM-MEDI_toolbox/MEDI_data/03_Invivo_GE"
files = [f for f in os.listdir(path) if not f.startswith('.')]
for f in files:
    data_path = os.path.join(path,f)
    basename_image = os.listdir(data_path)[0].split('_e')[0]    
    prepare_data(data_path, basename_image) """

prepare_data('/home/magic-chusj-2/Desktop/testData/MEDI_data/03_Invivo_GE/dcm2niix', 'AXL_QSM_MRB2_Stroke-Tramua_6.08_20111030211857_5')
